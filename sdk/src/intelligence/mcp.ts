...
import { McpServer } from "@modelcontextprotocol/sdk/api/mcp.js";
import { StreamableHTTPServerTransport } from "@modelcontextprotocol/sdk/api/streamableHttp.js";
import { StdioServerTransport } from "@modelcontextprotocol/sdk/api/stdio.js";
import { z } from "zod";
...
import { insert_fact } from "../temporalGraph/store";
import { query_facts_at_time } from "../temporalGraph/query";
  ...
  registry.tool(
    ...
    async ({
      ...
      if (type === "contextual" || type === "both") {
        ...
        if (u) {
          update_userSummary(u).catch((err) =>
      ...
      return {
        content: [
          { type: "text", text: txt },
          {
            type: "text",
            text: JSON.stringify(
              { ...results, user_id: u ?? null, project_id: proj },
              null,
              2,
            ),
          },
