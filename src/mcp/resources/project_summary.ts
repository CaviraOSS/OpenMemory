 ...
 *  ----------------------------------------------------------
 *  file  : src/mcp/resources/project_summary.ts
 *  usage : implements the LongMemory project summary component
 */
...
export function register_project_summary_resource(server: mcp_server_sdk, runtime: mcp_runtime): void {
    server.registerResource('longmemory-project-summary', new resource_template('longmemory://project/{project_id}/summary', { list: undefined }), {
