 ...
 *  ----------------------------------------------------------
 *  file  : src/mcp/resources/decisions.ts
 *  usage : implements the LongMemory decisions component
 */
...
export function register_decisions_resource(server: mcp_server_sdk, runtime: mcp_runtime): void {
    server.registerResource('longmemory-project-decisions', new resource_template('longmemory://project/{project_id}/decisions', { list: undefined }), {
