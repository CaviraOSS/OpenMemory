 ...
 *  ----------------------------------------------------------
 *  file  : src/mcp/resources/skills.ts
 *  usage : implements the LongMemory skills component
 */
...
export function register_skills_resource(server: mcp_server_sdk, runtime: mcp_runtime): void {
    server.registerResource('longmemory-project-skills', new resource_template('longmemory://project/{project_id}/skills', { list: undefined }), {
