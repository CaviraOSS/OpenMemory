...
export const env = {
    ...
    openai_base_url: process.env.OPENAI_BASE_URL || process.env.OM_OPENAI_BASE_URL || 'https://api.openai.com/v1',
    openai_model: process.env.OPENAI_EMBEDDING_MODEL || process.env.OM_OPENAI_EMBEDDING_MODEL || '',
    ...
    max_payload_size: Number(process.env.OM_MAX_PAYLOAD_SIZE) || 1e6,
