...
const API_ENDPOINTS: ApiEndpoint[] = [
  ...
  },
  {
    ...
    body: [
      { name: "content", type: "string", description: "Memory content" },
      {
        name: "sector",
        type: "string",
        description: "Target sector (episodic, semantic, etc.)",
      },
  ...
  },
  {
    ...
    response:
      '[{ "id": "...", "content": "...", "score": 0.95, "salience": 0.8, ... }]',
  },
  {
    method: "POST",
    path: "/memory/ingest",
    ...
    body: [
      {
        name: "file",
        type: "File",
        description: "PDF, DOCX, HTML, or TXT file",
      },
  ...
  },
  {
    ...
    params: [{ name: "id", type: "string", description: "Memory ID" }],
    response: '{ "id": "...", "content": "...", "salience": 0.8, ... }',
  },
  {
    method: "DELETE",
