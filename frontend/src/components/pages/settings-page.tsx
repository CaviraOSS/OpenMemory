      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Choose how memories are embedded</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  updateField(
                    "embeddingProvider",
                    v as Settings["embeddingProvider"],
                  )
                }
              >
              ...
              <p className="text-xs text-muted-foreground">
                Synthetic uses no external API. For production, use OpenAI or
                Gemini.
              </p>
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  updateField("theme", v as Settings["theme"])
                }
              >
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateField("autoRefresh", checked)
                }
              />
            </div>
            ...
            {formData.autoRefresh && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateField("refreshInterval", parseInt(e.target.value))
                  }
                  min={5000}
                  step={1000}
                />
