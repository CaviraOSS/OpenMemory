...
import { PageTransition, FadeIn, StaggerContainer } from '@/components/animations/page-transitions'
                ...
                <Card key={result.id}>
                  ...
                  <CardContent>
                    ...
                    <div className="mt-4 text-xs text-muted-foreground">
                      ID: {result.id} • Last seen: {formatDate(result.last_seen_at)}
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        <FadeIn delay={0.2}>
          <Card>
            <CardContent className="py-12 text-center text-muted-foreground">
              No results yet. Enter a query and click "Execute Query" to search.
            </CardContent>
          </Card>
        </FadeIn>
      )}
