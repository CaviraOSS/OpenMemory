...
const MemoriesPage = lazy(() =>
  import("./pages/memories-page").then((m) => ({ default: m.MemoriesPage })),
);
const QueryPage = lazy(() =>
  import("./pages/query-page").then((m) => ({ default: m.QueryPage })),
);
const GraphPage = lazy(() =>
  import("./pages/graph-page").then((m) => ({ default: m.GraphPage })),
);
const AnalyticsPage = lazy(() =>
  import("./pages/analytics-page").then((m) => ({ default: m.AnalyticsPage })),
);
const IngestPage = lazy(() =>
  import("./pages/ingest-page").then((m) => ({ default: m.IngestPage })),
);
const ApiDocsPage = lazy(() =>
  import("./pages/api-docs-page").then((m) => ({ default: m.ApiDocsPage })),
);
...
export function Dashboard() {
  ...
  const [loadedPages, setLoadedPages] = useState<Set<ViewId>>(
    new Set(["overview"]),
  );
