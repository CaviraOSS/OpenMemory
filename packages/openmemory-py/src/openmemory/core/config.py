...
class EnvConfig:
    def __init__(self):
        ...
        self.api_key = get("server", "api_key", "OM_API_KEY", "")
        self.require_auth = s_bool(get("server", "require_auth", "OM_REQUIRE_AUTH", "false"))
        self.port = int(num(os.getenv("OM_PORT"), 8080))
