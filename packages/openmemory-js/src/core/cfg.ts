...
export const env = {
    ...
    graphrag_enabled: bool(process.env.OM_GRAPHRAG_ENABLED),
    graphrag_url: str(process.env.OM_GRAPHRAG_URL, "http://127.0.0.1:8765"),
    graphrag_timeout_ms: num(process.env.OM_GRAPHRAG_TIMEOUT_MS, 120000),
    graphrag_write_enabled: bool(process.env.OM_GRAPHRAG_WRITE_ENABLED),
    graphrag_allow_unauth_write: bool(process.env.OM_GRAPHRAG_ALLOW_UNAUTH_WRITE),
    graphrag_allow_global_query: bool(process.env.OM_GRAPHRAG_ALLOW_GLOBAL_QUERY),
    graphrag_allow_unfiltered_scoped_query: bool(process.env.OM_GRAPHRAG_ALLOW_UNFILTERED_SCOPED_QUERY),
    graphrag_bridge_api_key: process.env.OM_GRAPHRAG_BRIDGE_API_KEY || "",
    graphrag_sync_on_add: bool(process.env.OM_GRAPHRAG_SYNC_ON_ADD),
    graphrag_context_enabled: bool(process.env.OM_GRAPHRAG_CONTEXT_ENABLED),
};
